...
public static class Ginput
{
	...
	//Ginput can handle as many of these as you want to throw at it buuuuut, unty can only handle so many and Ginput is wrapping unity input for now
	...
	/// <summary>
	/// Total possible device slots that Ginput may detect. (Including keyboard, mouse, virtual, and any slots)
	/// </summary>
	...
	/// <summary>
	/// Returns a copy of the current Ginput control list
	...
	/// <summary>
	/// List of connected gamepads that Ginput is aware of.
	/// </summary>
	public static string[] gamepads { get { CheckGamepads(); return _gamepads; } }
	/// <summary>
	/// Number of connected gamepads that Ginput is aware of.
	/// </summary>
	...
	public static void LoadControlScheme(ControlScheme scheme, bool loadCustomControls)
	{
		...
		List<Control> loadedControls = new();
		for (int i = 0; i < scheme.controls.Count; i++)
		{
			Control newControl = new(scheme.controls[i].name);
		...
		List<SmartControl> loadedSmartControls = new();
		for (int i = 0; i < scheme.smartControls.Count; i++)
		{
			SmartControl newControl = new(scheme.smartControls[i].name)
			{
				positiveControl = scheme.smartControls[i].positiveControl,
				negativeControl = scheme.smartControls[i].negativeControl,
				gravity = scheme.smartControls[i].gravity,
				deadzone = scheme.smartControls[i].deadzone,
				speed = scheme.smartControls[i].speed,
				snap = scheme.smartControls[i].snap,

				inversion = new bool[_totalPossibleDeviceSlots],
				scales = new float[_totalPossibleDeviceSlots]
			};
		...
		if (loadCustomControls && GinputFileIO.SaveDataExists(controlSchemeName))
		{
			_controls = GinputFileIO.LoadControls(_controls, controlSchemeName);
		}
	...
	/// <summary>
	/// Update Ginput.
	/// <para>This is called by all other Ginput functions so it is not necessary for you to call it in most circumstances.</para>
	/// </summary>
	public static void GinputUpdate()
	{
	...
	/// <summary>
	/// tells Ginput to return false/0f for any input checks until half a second has passed
	/// </summary>
	...
	/// <summary>
	/// tells Ginput to return false/0f for any input checks until the wait time has passed
	/// </summary>
	...
	/// <summary>
	/// Returns true if a Ginput Control or Smart Control is Held this frame
	/// </summary>
	/// <param name="controlName"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Returns true if a Ginput Control or Smart Control was Pressed this frame
	/// </summary>
	/// <param name="controlName"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Returns true if a Ginput Control or Smart Control was Released this frame
	/// </summary>
	/// <param name="controlName"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Returns true if a Ginput Control or Smart Control is Held this frame, regardless of the Control's toggle setting.
	/// </summary>
	/// <param name="controlName"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Returns true if a Ginput Control or Smart Control was Pressed this frame, regardless of the Control's toggle setting.
	/// </summary>
	/// <param name="controlName"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Returns true if a Ginput Control or Smart Control was Released this frame, regardless of the Control's toggle setting.
	/// </summary>
	/// <param name="controlName"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Returns true if a Ginput Control or Smart Control was Pressed this frame, or if it has been held long enough to start repeating.
	...
	private static bool ButtonCheck(string controlName, InputDeviceSlot slot, ButtonAction bAction, bool getRawValue = false)
	{
		...
		if (!controlFound) Debug.LogError("Ginput Error: Control \"" + controlName + "\" not found in list of controls or SmartControls.");
	...
	/// <summary>
	/// Returns the value of a Ginput Control or Smart Control.
	/// </summary>
	/// <param name="controlName"></param>
	...
	/// <summary>
	/// Returns the raw value of a Ginput Control or Smart Control
	/// </summary>
	/// <param name="controlName"></param>
	/// <returns></returns>
	...
	private static float AxisCheck(string controlName, InputDeviceSlot slot, bool getRawValue = false)
	{
	...
	private static Vector3 Vector3Check(string controlNameA, string controlNameB, string controlNameC, InputDeviceSlot slot, bool normalClip)
	{
	...
	public static bool GetToggle(string controlName)
	{
		...
		Debug.LogError("Ginput Error: Control \"" + controlName + "\" not found in list of Controls or SmartControls.");
		return false;
	}
	...
	public static void SetInverted(string smartControlName, bool invert, InputDeviceSlot slot = InputDeviceSlot.any)
	{
		...
		if (!controlFound) Debug.LogError("Ginput Error: Smart Control \"" + smartControlName + "\" not found in list of SmartControls.");
	}
	...
	public static bool GetInverted(string smartControlName, InputDeviceSlot slot = InputDeviceSlot.any)
	{
		...
		Debug.LogError("Ginput Error: Smart Control \"" + smartControlName + "\" not found in list of SmartControls.");
		return false;
	}
